...
const Navbar = () => {
  ...
  return (
    <nav
      id="nav"
      className={`bg-${isDarkTheme ? 'primary' : 'secondary'} text-neutral-50 transition-all w-full z-10 p-3 flex justify-end items-end fixed right-0 top-0 h-16`}
    >
      ...
      <div className="ml-auto">
        <FontAwesomeIcon
          ...
          className="text-xl cursor-pointer hover:text-neutral-300 transition-all"
